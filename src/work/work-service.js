...
export class WorkService {
  ...
  create({title,purpose,humanOwner,scope,domain='OIS',priority='MEDIUM',deadline='',expectedOutcome=''}){ const w={id:`WORK-${Date.now()}`,title,purpose,humanOwner,scope,domain,priority,status:'NEW',deadline,expectedOutcome,assignments:[],outputs:[],artifactIds:[],createdAt:new Date().toISOString()}; return this.save(w); }
