export const roleMenuKeys={
 SYSTEM_ADMIN:[['dashboard','menu.dashboard_system'],['imports','menu.imports'],['master','menu.master'],['accounts','menu.accounts'],['work','menu.work'],['settings','menu.settings'],['audit','menu.audit'],['advanced','menu.advanced']],
 RECTOR:[['dashboard','menu.dashboard_university'],['work','menu.work_decision'],['research','menu.research'],['data','menu.data_metrics']],
 VICE_RECTOR:[['dashboard','menu.dashboard_university'],['work','menu.work_decision'],['research','menu.research'],['data','menu.data_metrics']],
 DEPARTMENT_HEAD:[['dashboard','menu.dashboard_unit'],['work','menu.work'],['people','menu.people'],['research','menu.research'],['data','menu.data']],
